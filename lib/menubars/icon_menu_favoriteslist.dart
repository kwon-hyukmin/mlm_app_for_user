...
import 'package:mlm_app_for_user/icons/icon_star.dart';
...
class RegHome_menuIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: const Color(0xFF2E75B6)),
        child: Row(
          children: [
            Expanded(
                flex: 1,
                child: Center(
                  child: StarIcon(iConSize: iConSize,),
                )
            ),
            Expanded(
                flex: 2,
